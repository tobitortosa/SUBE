...
namespace Interface
{
    partial class UserDetails
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblUsername.Location = new Point(0, 115);
            ...
            lblEmail.Location = new Point(0, 243);
            ...
            lblApellido.Location = new Point(0, 181);
            ...
            lblNombre.Location = new Point(0, 61);
            ...
            label5.Location = new Point(0, 89);
            label5.Name = "label5";
            ...
            label4.Location = new Point(0, 215);
            label4.Name = "label4";
